...
## Project Structure
    ...
    ├── greendot_excel_test_30586  # Django project configurations
...
1. Clone this repo and `cd greendot_excel_test_30586`
...
2. Clone this repo and `cd greendot_excel_test_30586`
